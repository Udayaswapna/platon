    ...
    <div class="wrapper">
      ...
      <div id="content">
       ...
       <center> &nbsp;&nbsp;&nbsp;&nbsp; <button type="button" class="btn btn-primary btn-lg">RICE PRODUCTS</button>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <center> &nbsp;&nbsp; <a href="dairy.php"><button type="button" class="btn btn-outline-primary active ">All</button></a>
          &nbsp;&nbsp;<a href="Milk.php"><button type="button" class="btn btn-outline-secondary">Milk</button></a>
            &nbsp;&nbsp;<a href="Curd.php"><button type="button" class="btn btn-outline-success">Curd</button></a>
            &nbsp;&nbsp;<a href="Eggs.php"><button type="button" class="btn btn-outline-danger">Eggs</button></a>
          &nbsp;&nbsp;<a href="Gheedairy.php"><button type="button" class="btn btn-outline-warning">Gheedairy</button></a>
          &nbsp;&nbsp;<a href="Butter.php"> <button type="button" class="btn btn-outline-dark">Butter</button></a>
          &nbsp;&nbsp;<a href="Buttermilk.php"><button type="button" class="btn btn-outline-info">Buttermilk</button></a></center>
...
?>
          ...
          <div class="content-wrap">
            ...
            <br />
            <?php
				$query = "SELECT * FROM tbl_product where prodtype='Buttermilk'";
