      ...
      <div id="content">
       ...
       <center> &nbsp;&nbsp;&nbsp;&nbsp; <button type="button" class="btn btn-primary btn-lg">RICE PRODUCTS</button>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <center> &nbsp;&nbsp; <a href=""><button type="button" class="btn btn-outline-primary active ">All</button></a>
          &nbsp;&nbsp;<a href="basmati.php"><button type="button" class="btn btn-outline-secondary">Green Moong</button></a>
            &nbsp;&nbsp;<a href="kolam.php"><button type="button" class="btn btn-outline-success">Urad Dal </button></a>
            &nbsp;&nbsp;<a href="red.php"><button type="button" class="btn btn-outline-danger">Masoor Dal</button></a>
          &nbsp;&nbsp;<a href="masoori.php"><button type="button" class="btn btn-outline-warning">Toor/Arhar Dal</button></a>
          &nbsp;&nbsp;<a href="brown.php"> <button type="button" class="btn btn-outline-dark"> Lobia</button></a>
          &nbsp;&nbsp;<a href="broken.php"><button type="button" class="btn btn-outline-info">Matar Dal</button></a></center>
...
?>
          ...
          <div class="content-wrap">
            ...
            <br />
            <?php
				$query = "SELECT * FROM tbl_product where cattype='rice'";
