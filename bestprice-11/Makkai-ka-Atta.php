    ...
    <div class="wrapper">
      ...
      <div id="content">
        ...
        .btn-outline-dark {
          ...
          border: 1px solid;
          padding: 10px;
          box-shadow: 2px 2px 3px 3px #D0E1F9;
          }
       ...
       <center> &nbsp;&nbsp;&nbsp;&nbsp; <button type="button" class="btn btn-primary btn-lg">RICE PRODUCTS</button>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <center> &nbsp;&nbsp; <a href="atta.php"><button type="button" class="btn btn-outline-primary active ">All</button></a>
          &nbsp;&nbsp;<a href="Gehoon-Atta.php"><button type="button" class="btn btn-outline-secondary">Gehoon-Atta</button></a>
            &nbsp;&nbsp;<a href="Maida-Atta.php"><button type="button" class="btn btn-outline-success">Maida-Atta</button></a>
            &nbsp;&nbsp;<a href="Bajri-ka-Atta.php"><button type="button" class="btn btn-outline-danger">Bajri-ka-Atta</button></a>
          &nbsp;&nbsp;<a href="Besan-Atta.php"><button type="button" class="btn btn-outline-warning">Besan-Atta</button></a>
          &nbsp;&nbsp;<a href="Rice-Flour.php"> <button type="button" class="btn btn-outline-dark">Rice-Flour</button></a>
          &nbsp;&nbsp;<a href="Makkai-ka-Atta.php"><button type="button" class="btn btn-outline-info">Makkai-ka-Atta</button></a></center>
          <?php 
...
?>
          ...
          <div class="content-wrap">
            ...
            <br />
            <?php
				$query = "SELECT * FROM tbl_product where prodtype='Makkai-ka-Atta'";
                    ...
                    <div class="lrc-item" >
                      ...
                      <img src="images/<?php echo $row["image"]; ?>" class="img-responsive"/>
                        ...
                        <div class="lrc-desc">
                          ...
                          <div class="lrc-title">
                            <?php echo '<span style="color:black; font-style:bold; font-size:20px;">' .$row["name"]; ?>
                          </div>


                          <div class="lrc-text">

                            ₹ <?php echo '<span style="color:black; font-style:bold; font-size:15px;">' .$row["price"]; ?>
                          </div>
                          <div class="lrc-button">
                            ...
                            <div class="lrcb-right">
                              <!--<button class="button2 button1">BUY NOW</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
