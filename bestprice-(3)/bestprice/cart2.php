      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-header">
        <div class="container-fluid">
          ...
          <div class="logo">BEST PRICE
            ...
            <a href="checkout11.php"> <button type="button" class="btn"> <i class="fa fa-shopping-cart" aria-hidden="true"> </i> <span class=""><?php if(isset($_SESSION["shopping_cart"])) { echo count($_SESSION["shopping_cart"]); } else { echo '0';}?></span>
                               ...
                               <table class="table table-bordered">  
                                   <tr> <tr>  
                                    ...
                                    <tr>  
                                      ...
                                      <input type="submit" name="place_order" class="btn btn-warning" id="abc" value="Place Order" />  
                                         </td>  
                                    </tr>  
                                    <?php  
                                    }  
                                    ?> 
<script>  var button = document.getElementById('abc');

button.onclick = function (event) {
    event.preventDefault();
    alert('ORDERED SUCCESS FULLY');
